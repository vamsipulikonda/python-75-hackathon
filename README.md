...
## 1. Regular progress, Clean Coding & Clear Documentation (Maximum 110 points)
...
## 2. Genuine Code (no copy paste ), Clear folder structure (Maximum 140 points)
...
## 3. Run without any errors & Code Diversity (Maximum 100 points)
...
## 4. Error Archive storage (Maximum 30 points)
...
## 5. Talent Accurate Profile & Project update (Maximum 80 points)
...
## 6. Code validation on Zoom call (Maximum 25 points)
...
## 7. Minimum one comment (peer/expert) on your project & 2 like bubbles (Maximum 15 points)
